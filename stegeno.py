...
# Reading the image
x = cv2.imread(r"N:\python\opencv-python-4.10.0.84\cv2\data\paris.jpg")
i, j, k = x.shape
print(i, j, k)

# Input security key and text to hide
key = input("\nEnter  value of  secret key: ")
...
print("Data is hidden in the Image  successfully.")
...
if ch == 1:
    ...
    print("Don't Want To Unhide The Text, then exit the code!!!!")
